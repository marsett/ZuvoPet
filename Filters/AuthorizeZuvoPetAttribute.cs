...
namespace ZuvoPet.Filters
{
    public class AuthorizeZuvoPetAttribute : AuthorizeAttribute, IAuthorizationFilter
    {
        private readonly string[] _tiposUsuario;

        public AuthorizeZuvoPetAttribute(params string[] tiposUsuario)
        {
