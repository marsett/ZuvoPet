...
namespace ZuvoPet.Controllers
{
    public class ManagedController : Controller
    {
        private readonly ZuvoPetContext context;
        private readonly IRepositoryZuvoPet repo;
        public ManagedController(ZuvoPetContext context, IRepositoryZuvoPet repo)
        {
        ...
        public async Task<IActionResult> Landing()
        {
            ...
            //Console.WriteLine("Tipo de usuario landing: " + tipoUsuario);
            ...
            List<HistoriaExito> historiasLimitadas = historiasExito.Take(3).ToList();
