...
namespace ZuvoPet.Controllers
{
    ...
    public class AdoptanteController : BaseController
    {
        ...
        public AdoptanteController(ZuvoPetContext context, IRepositoryZuvoPet repo, HelperPathProvider helperPath)
        {
